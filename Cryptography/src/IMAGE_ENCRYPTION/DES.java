...
public class DES extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try
        {
            ...
            String file_p = "DES/encrypted/enc_"+f.getName();
            FileOutputStream outputstream  = new FileOutputStream(file_p);
            System.out.println("Original image size: "+(file.available() / 1024)+"kb \n");
            ...
            file = new FileInputStream(file_p);
            System.out.println("Encrypted (DES) Image size: "+(file.available() / 1024)+"kb \n");
            file.close();
            outputstream.flush();
            cos.close();
            ...
            JOptionPane.showMessageDialog(null,"Image Encrypted using DES Algorithm");
        }
        catch(Exception e)
        {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try
        {
           long strt = System.nanoTime();
            FileInputStream file = new FileInputStream(file_path.getText());
            String file_p = "DES/decrypted/dec_"+f.getName();
            FileOutputStream outputstream  = new FileOutputStream(file_p);
            ...
            file = new FileInputStream(file_p);
            System.out.println("Decrypted (DES) Image size: "+(file.available() / 1024)+"kb \n");
            file.close();
            outputstream.flush();
            cos.close(); 
            long end =System.nanoTime();
            long timeElapsed = end - strt;
            System.out.println("Decryption Time: " + timeElapsed/1000000+"ms");
            
            JOptionPane.showMessageDialog(null,"Image Decrypted using DES Algorithm");
        }
        catch(Exception e)
        {
