 ...
 */
public class table_op extends javax.swing.JFrame {
Connection con =null;
...
ResultSet rs =null;
         ...
         int sn=0;
          ...
          sn++;
             ...
             String password=rs.getString("password");
                model1.insertRow(model1.getRowCount(),new Object[]{sn,id,username,password});
            }    
        }
        catch(Exception e){
            JOptionPane.showMessageDialog(null,"Error in Fetching Query");
        }  
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String value = String.valueOf(model1.getValueAt(selectedRow,selectedCol));
          ...
          ps=con.prepareStatement("delete from login where id = '"+value+"' or username = '"+value+"' or password = '"+value+"' ");
          ps.executeUpdate();
        ...
        jComboBox1.setSelectedItem(selected);
         ...
         int sn=0;
          ...
          sn++;
             ...
             try{
          ps=con.prepareStatement("select * from login limit 0,5 ");
         rs=ps.executeQuery();
         int sn=0;
            while(rs.next()){
          sn++;
             ...
             try{
          ps=con.prepareStatement("select * from login limit 0,10 ");
         rs=ps.executeQuery();
         int sn=0;
            while(rs.next()){
          sn++;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      ...
      try{
        ...
        String value = String.valueOf(model1.getValueAt(selectedRow,selectedCol));
          ...
          ps=con.prepareStatement("select * from login where id = '"+value+"' or username = '"+value+"' or password = '"+value+"' ");
          rs=ps.executeQuery();
          rs.next();
          int id=rs.getInt("id");
          String username=rs.getString("username");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(table_op.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
    //</editor-fold>
