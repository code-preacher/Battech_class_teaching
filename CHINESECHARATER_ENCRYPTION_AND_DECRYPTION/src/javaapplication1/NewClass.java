...
//        
//      //  newText = newText.replaceAll("\\s+", Matcher.quoteReplacement(" "));
//
//               
//        for (int i = 0; i < newText.length(); i++) {
//            
//            char x = newText.charAt(i);
//            System.out.println("the text is...."+newText.charAt(i));
//
//            String y = (Integer.toHexString(x)).length() < 2 ? "0"+ Integer.toHexString(x) : Integer.toHexString(x);
//             
//            joinedText = joinedText.concat(y);
...
//                
//                char[]  jText = joinedText.toCharArray();
//                                 
//                for(int k = jText.length - 1 ;  k >= 0;  k--) {
//
//                    swappedText.append(jText[k]);
//                                        
//                    if(swappedText.length() == 2) {
//                        
//                        yy = swappedText.substring(0,1);
//                        xx = swappedText.substring(1);
//                        
//
//                          
...
//                        System.out.println(" ");
//                    }
//                    else if(swappedText.length() > 3) {
//                      String nText =  swappedText.substring(2);
//                       
//                       yy = nText.substring(0,1);
//                       xx = nText.substring(1);
//                          
//                    for(int b = 1; b < table.length; b++) {
//                      if(table[0][b].equalsIgnoreCase("0"+xx)) {
//                          x1 = b;
...
//                    }
//                    
//                    if(swappedText.length() == 2 || swappedText.length() == 4) {
//                         //System.out.println("\t");
//                        for(int b = 1; b < table.length; b++) {
//                          swap(table, b );
//                          System.out.print(table[0][b]+"\t"); 
...
//            
//            System.out.println(" print the yy is "+yy);
//            System.out.println(" print the xx is "+xx);
//                          
//            for(int b = 0; b < table.length; b++) {
//               // System.out.println(" I pirnted "+"0"+xx);
...
//             // System.out.print(table[0][b]+"\t"); 
//            }
//            System.out.println(" the points is "+tmpTable[y1][x1]);
//
//                        
//            enc.append(tmpTable[y1][x1]); 
//            System.out.println(" ");
...
//            System.out.println(" ");
//             
//           // System.out.println("combinedhex is "+combinedHex);
//           // System.out.println("the combined length is "+combinedHex.length());
//             
//            if(combinedHex.length() == 4) {
//             //   System.out.println("the combined hex is "+combinedHex);
//                                
//
//                 
//                char[]  jText = combinedHex.toString().toCharArray();
//                 
//                for(int k = jText.length - 1 ;  k >= 0;  k--) {
//
//                    swappedText.append(jText[k]);
//                    
//                    if(swappedText.length() == 2) {
//                      enc.append((char) (Integer.decode("#" +swappedText.substring(0,2))).intValue());  
//                    }
//                    else if(swappedText.length() > 3) {        
//                      enc.append((char) (Integer.decode("#" +swappedText.substring(2))).intValue());   
//                    }
//                }
//                combinedHex.delete(0, 4);
...
//          System.out.println("\t");
//
//        return enc.toString().replace("£", " ").replace("$", "");
//        //return enc.toString();
//            
//      }
//   
...
//        try {
//            
//           // Scanner in = new Scanner(new FileReader("/Users/eddie/Downloads/ibro.txt"));
//             FileReader reader = new FileReader("/Users/eddie/Downloads/ibro.txt");
...
//        try{
//             FileWriter writer = new FileWriter("/Users/eddie/Downloads/ibro.txt", false);
