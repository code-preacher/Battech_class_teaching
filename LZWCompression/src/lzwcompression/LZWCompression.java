...
public class LZWCompression {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter the image to compress with it's URL and extension: ");
        ...
        try {
            ...
            System.out.println("Compression complete! file saved: "+getFileNameWOExtn[0].concat(".lzw")+"!");      
        }
