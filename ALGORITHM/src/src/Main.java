...
public class Main extends ApplicationFrame{
    ...
    static double[] time_taken_bubble;
    static double[] time_taken_insertion;
    ...
    private XYDataset createDataset() {
      ...
      final XYSeries linearSearch = new XYSeries( "Bubble" ); 
      
      for(int i = 0; i < 200; i++){
          linearSearch.add(i, time_taken_bubble[i]);
      }         
      
      final XYSeries binarySearch = new XYSeries( "Insertion" );   
      
      for(int i = 0; i < 200; i++){
          binarySearch.add(i, time_taken_insertion[i]);
      }           
      ...
      dataset.addSeries( linearSearch );
    ...
    public static void main(String[] args){
        ...
        time_taken_bubble = new double[200];
        time_taken_insertion = new double[200];
        ...
        Algorithms algo = new Algorithms(); 
         ...
         for(int i = 5; i <= 1000; i+=5){
             ...
             printArray(temp1);
             time_taken_insertion[(i/5)-1] = algo.InsertionSort(temp1);
             printArray(temp1);
             
             copyArray(array, temp2);
             printArray(temp2);
             time_taken_bubble[(i/5)-1] = algo.bubbleSort(temp2);
             printArray(temp2);
             
             copyArray(array, temp3);
             printArray(temp3);
             time_taken_merge[(i/5)-1] = algo.mergeSort(temp3, 0, (i-1));
             printArray(temp3);
             
               copyArray(array, temp4);
             printArray(temp4);
             time_taken_radix[(i/5)-1] = algo.radixSort(temp4, (i-1));
             printArray(temp4);
             
             copyArray(array, temp5);
             printArray(temp5);
             time_taken_quick[(i/5)-1] = algo.quickSort(temp5, 0, (i-1));
             printArray(temp5);
